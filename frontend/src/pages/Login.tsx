  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-10 w-72 h-72 bg-indigo-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Link to="/" className="flex items-center justify-center space-x-3 mb-8 group">
          <img src="/logo.jpg" alt="Mator Life" className="h-16 w-16 object-cover rounded-2xl shadow-xl group-hover:scale-105 transition-transform duration-300" />
        ...
        <div className="relative">
          ...
          {/* Main Card */}
          <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 animate-slide-up">
            ...
            <div className="flex justify-center mb-6">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200/50 rounded-full px-4 py-2">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="group">
                ...
                <div className="relative">
                  <input
                    ...
                    type="text"
                    className="input group-hover:border-blue-400 transition-all duration-300"
              ...
              <div className="group">
                ...
                <div className="relative">
                  <input
                    ...
                    className="input pr-12 group-hover:border-blue-400 transition-all duration-300"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="relative w-full btn-lg group overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed mt-6"
              >
                {/* Button Glow Effect */}
            ...
            <div className="mt-6 text-center">
              <Link
                to="/"
                className="text-sm text-gray-600 hover:text-blue-600 font-medium transition-colors inline-flex items-center group"
              >
